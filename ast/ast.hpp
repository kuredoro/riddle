...
namespace ast
{
    ...
    struct Program : Node
    {
        ...
        {
            return Node::operator==(other) && routines == other.routines && variables == other.variables && types == other.types;
        }
    ...
    struct Routine : Node
    {
        ...
        {
            return Node::operator==(other) && name == other.name && returnType == other.returnType && body == other.body && parameters == other.parameters;
        }
        void accept(Visitor &v) override
        {
            v.visit(this);
    ...
    struct Parameter : Node
    {
        ...
        {
            return Node::operator==(other) && name == other.name && type == other.type;
        }
        void accept(Visitor &v) override
        {
            v.visit(this);
 ...
 */
    ...
    struct ArrayType : Type
    {
        ...
        {
            return Node::operator==(other) && length == other.length && elementType == other.elementType;
        }
        void accept(Visitor &v) override
        {
            v.visit(this);
    ...
    struct WhileLoop : Statement
    {
        ...
        {
            return Node::operator==(other) && condition == other.condition && body == other.body;
        }
        void accept(Visitor &v) override
        {
            v.visit(this);
    ...
    struct ForLoop : Statement
    {
        ...
        {
            return Node::operator==(other) && loopVar == other.loopVar && rangeFrom == other.rangeFrom && rangeTo == other.rangeTo && reverse == other.reverse && body == other.body;
        }
        void accept(Visitor &v) override
        {
            v.visit(this);
    ...
    struct IfStatement : Statement
    {
        ...
        {
            return Node::operator==(other) && condition == other.condition && ifBody == other.elseBody && ifBody == other.elseBody;
        }
        void accept(Visitor &v) override
        {
            v.visit(this);
