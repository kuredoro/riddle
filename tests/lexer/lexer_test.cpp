    ...
    std::vector<std::vector<lexer::Token>> result{
        {
            ...
            {       TokenType::If, 1,  1,   "if"}, {     TokenType::Ident, 1,  4, "sausage"}, 
            {     TokenType::Loop, 1, 12, "loop"}, {       TokenType::End, 1, 17,     "end"},
            {       TokenType::Is, 1, 21,   "is"}, {     TokenType::Ident, 1, 24,    "near"},
        },
        {
            ...
            {       TokenType::Is, 2, 13,   "is"}, {     TokenType::Ident, 2, 16,    "near"},
            {  TokenType::NewLine, 2, 20,   "\n"}, {       TokenType::End, 3,  1,     "end"},
            {  TokenType::NewLine, 3,  4,   "\n"},
        },
        { 
            {    TokenType::Var, 1,  1, "var"}, {      TokenType::Ident, 1,  5,  "an_int"},
            {  TokenType::Colon, 1, 11,   ":"}, {TokenType::IntegerType, 1, 13, "integer"}, 
            {TokenType::NewLine, 1, 20,  "\n"},
        },
        {
            {        TokenType::If, 1,  1,   "if"}, {    TokenType::OParen, 1,  4,  "("}, 
            {     TokenType::Ident, 1,  5,    "x"}, {       TokenType::Add, 1,  6,  "+"},
            {     TokenType::Ident, 1,  7,    "y"}, {    TokenType::CParen, 1,  8,  ")"},
            {       TokenType::Leq, 1,  9,   "<="}, {     TokenType::Ident, 1, 11,  "z"},
            {      TokenType::Then, 1, 13, "then"}, {   TokenType::NewLine, 1, 17, "\n"},
        },
        {
            {     TokenType::Ident, 1,  1, "TokenType"}, {     TokenType::Colon, 1, 10,     ":"},
            {     TokenType::Colon, 1, 11,         ":"}, {     TokenType::Ident, 1, 12, "Colon"},
            { TokenType::Semicolon, 1, 17,         ";"},
        },
        { 
            {    TokenType::Var, 1,  1, "var"}, {         TokenType::Ident, 1,  5,     "ans"},
        ...
        },
        {
            ...
            {TokenType::Ident, 2, 1, "waffles"},
        },
        {
            {    TokenType::Var, 1,  1, "var"}, {  TokenType::Ident, 1,  5,   "x"},
            {     TokenType::Is, 1,  7,  "is"}, {   TokenType::Real, 1, 10,  "4."},
            {TokenType::NewLine, 1, 12,  "\n"}, {    TokenType::Var, 2,  1, "var"},
            {  TokenType::Ident, 2,  5,   "y"}, {     TokenType::Is, 2,  7,  "is"},
